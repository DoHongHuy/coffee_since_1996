...
public class ValidateUtils {
    ...
    public static final String TABLE_REGEX = "[0-9]{2}|[1-9]";

    public static boolean isTableValid(String number){

        return Pattern.compile(TABLE_REGEX).matcher(number).matches();
    }
